...
export const SKYLINE_CARDS: SkylineCard[] = [
  ...
  },
  {
    ...
    highlights: [
      'Led lifting mechanism as designated lead, designing a ball-screw driven system to elevate the barrel and clock the bung plug to target orientation',
      ...
      'Ran FEA on the lifting frame under worst-case barrel loading, verifying stress concentrations and deflection stayed within acceptable limits',
      'Conducted barrel force push characterization tests at multiple floor angles to define real design load inputs',
      'Designed the bung clocking mechanism for repeatable angular alignment, validated with repeated live tests on the physical barrel',
      'Integrated lifting, rolling, and locomotion subsystems, resolving interface conflicts and coordinating sequencing with the controls team',
  ...
  },
  {
    ...
    result: 'Functional depth adjustment prototype demonstrated in an aquatic environment. The submersible successfully adjusted depth on command.',
    highlights: [
  ...
  },
  {
    ...
    problem: 'Four things broke in sequence: joints too tight to move (STL tolerances don\'t match), cables slipping off the servo pulley under load, stiffness returning after filing, and every battery config tried (4xAA and NiMH packs) either lacked current or dropped voltage mid-actuation with five servos running.',
    ...
    highlights: [
      ...
      'Resolved power supply instability after testing 4xAA and 6xAA NiMH packs. Settled on a 6.8V / 7A regulated DC supply.',
    ],
    tags: ['Robotics', '3D Printing', 'Servo', 'Mechanisms'],
  },
  {
    ...
    result: 'Modular design: the threaded interface allows different hammer heads to attach to the same handle for multiple applications. One handle, multiple tools.',
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Evaluated rack-and-pinion vs. gravity-fed delivery, selecting gravity-fed for lower mass and simpler design',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Conducted FEA analysis to verify structural integrity under hydraulic forces, confirming FOS ≥ 3',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Fastener and material stiffness calculations at the clamp-rail interface, verifying FOS against bolt failure and loosening',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Modeled obstacle avoidance in Simscape, verifying manipulator positioning against theoretical joint angle ranges',
  ...
  // ── Work Experience (blue) ─────────────────────────────────────────────────
  {
    ...
    cardDescription: '62.55% cost reduction via sheet metal conversion. Linear-actuator test rig. Scoop trailer unloader.',
    accent: 'blue',
    ...
    result: '62.55% part cost reduction ($750 → $280.89/unit). Chute cut test lead time by 3+ weeks and saved up to $10K+ per system.',
...
export const WORKBENCH_TOOLS: WorkbenchTool[] = [
  ...
  },
  {
    ...
    category: 'experience',
    featured: true,
    shortDescription: 'Mechanical Co-Op. 62.55% cost reduction via sheet metal conversion.',
    longDescription: {
      ...
      result: '62.55% part cost reduction ($750 → $280.89/unit). Chute saved 3+ weeks lead time and up to $10K+ per system.',
    },
...
export const EXPERIENCE: Job[] = [
  {
    ...
    highlights: [
      ...
      'Converted a machined PLI body to sheet-metal with CNC ribs, reducing part cost 62.55% and lead time by over 2 weeks',
    ...
    projects: [
      ...
      },
      {
        ...
        pairItems: [
          ...
          { label: 'Miniature Scoop Models, scaled physical models gifted to clients and customer teams', images: [
